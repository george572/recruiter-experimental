...
export function ProfileSlidePanel({ open: openProp, onOpenChange }: ProfileSlidePanelProps) {
    ...
    <>
      ...
      >
        <div className="flex shrink-0 items-center justify-between border-b border-border/60 p-8">
          <h2 className="text-sm font-semibold text-foreground">პროფილი</h2>
          <button
            type="button"
            aria-label="პროფილის დახურვა"
            onClick={() => setOpen(false)}
